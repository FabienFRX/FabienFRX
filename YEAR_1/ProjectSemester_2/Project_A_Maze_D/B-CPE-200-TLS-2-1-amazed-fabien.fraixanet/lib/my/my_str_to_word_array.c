...
static bool char_is_in_str(char c, char *str)
{
...
static int word_counter(char *str, char *stop)
{
    int nb_word = 0;
...
static int sizeof_word(char *str, int *j, char *stop)
{
    int size_word = 0;
...
char **my_str_to_word_array(char *str, char *stop)
{
    ...
    for (int i = 0; i < nb_word; i++) {
        ...
        w_array[i] = malloc(sizeof(char) * size_word);
