...
class CommandParser {
    ...
    std::string handleLIST(const std::vector<std::string>& args, const std::string& currentDir, const std::string& rootDir, int clientSocket);
    std::string handleRETR(const std::vector<std::string>& args, int clientSocket, const std::string& currentDir, const std::string& rootDir);
    std::string handleSTOR(const std::vector<std::string>& args, int clientSocket, const std::string& currentDir, const std::string& rootDir);
...
std::string handlePASVString(int clientSocket);
